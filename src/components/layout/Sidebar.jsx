            ...
            return (
              <li key={index}>
                {isDisabled ? (
                  ...
                  <Link
                    to={item.path}
                    className={`relative group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 transform hover:scale-[1.02] ${
                      isCollapsed ? "justify-center" : ""
                    } ${
                      isActive
                        ? "bg-gradient-to-r from-[#23407a] to-[#3b5fa4] text-white shadow-lg shadow-[#23407a]/25"
                        : "text-gray-700 hover:bg-gradient-to-r hover:from-[#23407a]/10 hover:to-blue-500/10 hover:text-[#23407a] border border-transparent hover:border-[#23407a]/20"
                    }`}
                      ...
                      <div className="flex-1 flex items-center justify-between ml-4">
                        <span
                          className={`transition-colors ${
                            isActive
                              ? "text-white"
                              : "text-gray-700 group-hover:text-[#23407a]"
                          }`}
                        >
                          {item.label}
                        </span>
